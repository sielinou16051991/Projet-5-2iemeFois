            ...
            <div class="row">
                ...
                <div class="col-md-6">
                  ...
                  <div class="col-half">
                    ...
                    <label for="file" id="errorMessageFile" class="type-file-control errorMessageFile text-danger" data-testid="error-message-file">choisir une image de type: 'image/png', 'image/jpg' ou 'image/jpeg'</label>
                  </div>
                </div>
            </div>
            <div class="row">
